      ...
      <div className={classes.container}>
        <div id="navigation-pills">
          <div className={classes.title}>
            <h1>
              Consulta Presencial e <strong>Online</strong>
            </h1>
          </div>
          ...
          <GridContainer
            ...
            alignItems="center"
          >
            <GridItem xs={12} sm={6} md={6} spacing={1}>
              <h4 className={classes.textCenter}>
                Meu consultório físico fica localizado na Rua Hortência Dutra
                397, Centro - Balneário Arroio do Silva. clique no mapa{" "}
                {isSmall ? "abaixo" : "ao lado"} para ver a localização exata e
                venha fazer uma visita. Se você preferir(em situações como a
                pandemia do COVID-19, por exemplo), possuo a metodologia de
                consulta online, voce pode resolver seus problemas e
                dificuldades direto da sua casa!
              </h4>
              <Button
                color="success"
            ...
            <GridItem xs={12} sm={6} md={6}>
              ...
              >
                <img
                  ...
                  alt="consultório do fabiano correa"
                />
              </a>
            </GridItem>
          </GridContainer>
                ...
                <div className={classes.card}>
                  ...
                  {e.price !== "oculto" ? (
                    <>
                      ...
                      <h4>
                        <strong>
                          {parseFloat(e.price) !== parseFloat(e.totalPrice)
                            ? "Total por pacote:"
                            : "Total por sessão:"}{" "}
                          R${e.totalPrice}
                        </strong>
                      ...
                      <Button
                        ...
                        size="lg"
                        href={`https://api.whatsapp.com/send?phone=554899673317&text=Ol%C3%A1%20fabiano,%20quero%20fazer%20o%20Pacote%20de%20${numPlans[i]}%20consulta%20de%20Hipnose`}
                      >
                        Quero este pacote!{" "}
